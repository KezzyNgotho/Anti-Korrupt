...
shared (_init_msg) actor class KnowledgeFoundNFT(
  _args : {
  ...
  stable var admin = _args.admin_principal;  // the admin of the canister

  stable var icrc7_migration_state = ICRC7.init(
    ICRC7.initialState(),
    #v0_1_0(#id),
    ICRC7Default.defaultConfig(admin),
    admin,
  );
  ...
  stable var icrc37_migration_state = ICRC37.init(
    ICRC37.initialState(),
    #v0_1_0(#id),
    ICRC37Default.defaultConfig(admin),
    admin,
  );
  ...
  stable var icrc3_migration_state = ICRC3.init(
    ICRC3.initialState(),
    #v0_1_0(#id),
    ICRC3Default.defaultConfig(admin),
    admin,
  );
