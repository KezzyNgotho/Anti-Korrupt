<script lang="ts">
  ...
  let addingToCourseKnowledgeBase = false;
      ...
      <div class="space-y-8">
        ...
        {#if activeTab === "claim-nfts"}
          <section class="bg-white p-8 rounded-lg shadow-xl">
            ...
            <p class="text-gray-700 mb-6">
              Here you can claim your Knowledge Found NFTs for various courses.
              Connect your identity and enjoy your rewards
            </p>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          {#if addingToCourseKnowledgeBase}
                            Adding to Course Knowledge Base
                          {/if}
                        </button>
                      </form>
                    </div>
